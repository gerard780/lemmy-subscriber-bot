...
def main():
    ...
    parser.add_argument("--threshold-add", default=int(os.environ.get("LEMMY_THRESHOLD_ADD", 10)))
    parser.add_argument("--threshold-subscribe", default=int(os.environ.get("LEMMY_THRESHOLD_SUBSCRIBE", 50)))
